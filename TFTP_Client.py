...
ERROR_CODE = {0: "정의되지 않은 오류", 1: "파일을 찾을 수 없음", 2: "액세스 위반", 3: "디스크가 꽉 찼거나 할당이 초과됨", 4: "잘못된 TFTP 작업",
              5: "알 수 없는 전송의 ID", 6: "파일이 이미 존재함", 7: "해당 사용자가 없음"}
...
sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)  # UDP 소켓 생성 변수

# 파일을 읽거나 쓸 때, 어떤 오류가 발생하더라도 안전하게 닫히도록 사용하는 with 문
